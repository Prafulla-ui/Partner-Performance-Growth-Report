...
export const supplyKpis: KpiMetric[] = [
  ...
  },
  {
    ...
    status: 'watch',
    tooltip:
      'RateGain AI Vision score for hotel imagery: photo quality, room and amenity coverage, tagging accuracy, and visual consistency across brand and OTA galleries.',
    trend: [54, 57, 60, 63, 66, 68],
    share: {
      label: 'Images at standard',
      value: '1,842 of 2,410',
      comparisons: { qoq: 86, yoy: 214, kind: 'abs' },
      tooltip: 'Property photos that meet the AI Vision quality and tagging standard this quarter.',
    },
  },
  {
    id: 'indirect-rev',
...
export const channelMix = [
  ...
  { name: 'Offline / other', value: 25.5, color: '#94A3B8' },
]
